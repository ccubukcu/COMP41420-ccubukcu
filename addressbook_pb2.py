...
_ACTIONREPLY = _descriptor.Descriptor(
  name='ActionReply',
  full_name='tutorial.ActionReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='message', full_name='tutorial.ActionReply.message', index=0,
...
_LISTPERSONSREQUEST = _descriptor.Descriptor(
  ...
  full_name='tutorial.ListPersonsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
ActionReply = _reflection.GeneratedProtocolMessageType('ActionReply', (_message.Message,), dict(
  DESCRIPTOR = _ACTIONREPLY,
  __module__ = 'addressbook_pb2'
  # @@protoc_insertion_point(class_scope:tutorial.ActionReply)
  ))
_sym_db.RegisterMessage(ActionReply)

ListPersonsRequest = _reflection.GeneratedProtocolMessageType('ListPersonsRequest', (_message.Message,), dict(
  DESCRIPTOR = _LISTPERSONSREQUEST,
  __module__ = 'addressbook_pb2'
  # @@protoc_insertion_point(class_scope:tutorial.ListPersonsRequest)
  ))
...
class EarlyAdopterPersonServiceServicer(object):
  """<fill me in later!>"""
  ...
  def ListPersons(self, request, context):
    raise NotImplementedError()
class EarlyAdopterPersonServiceServer(object):
  """<fill me in later!>"""
  __metaclass__ = abc.ABCMeta
  @abc.abstractmethod
  def start(self):
  ...
  def stop(self):
    raise NotImplementedError()
class EarlyAdopterPersonServiceStub(object):
  """<fill me in later!>"""
  __metaclass__ = abc.ABCMeta
  @abc.abstractmethod
  ...
  @abc.abstractmethod
  def ListPersons(self, request):
    raise NotImplementedError()
  ListPersons.async = None
def early_adopter_create_PersonService_server(servicer, port, root_certificates, key_chain_pairs):
  ...
  method_service_descriptions = {
    "AddPerson": utilities.unary_unary_service_description(
      ...
      addressbook_pb2.ActionReply.SerializeToString,
    ),
    "ListPersons": utilities.unary_unary_service_description(
      servicer.ListPersons,
      addressbook_pb2.ListPersonsRequest.FromString,
...
def early_adopter_create_PersonService_stub(host, port):
  import addressbook_pb2
  import addressbook_pb2
  import addressbook_pb2
  import addressbook_pb2
  method_invocation_descriptions = {
    "AddPerson": utilities.unary_unary_invocation_description(
      ...
      addressbook_pb2.ActionReply.FromString,
    ),
    "ListPersons": utilities.unary_unary_invocation_description(
      addressbook_pb2.ListPersonsRequest.SerializeToString,
